...
echo "[entrypoint] Running business schema migrations"
NODE_PATH=/app/migrate-tools/node_modules node /app/src/db/run-business-migrations.mjs
echo "[entrypoint] Business schema migrations completed"
